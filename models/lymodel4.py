...
from models.hardmaxattention import HardMaxAttention
...
class Model(BaseModel):
    def __init__(self, config:dict) -> None:
        ...
        self.tanh1 = nn.Tanh()
        self.attn = HardMaxAttention(self.word_output_size)
    ...
    def forward(self, X):
        ...
        attn_bbox, score = self.attn(output, transform_x, 
                        transform_x, img_key_padding_mask) # 找到对应的bbox
